...
/*
5. Considera que estás desarrollando un programa donde necesitas trabajar con objetos de tipo Rueda (que representa a una rueda de un vehículo). Realizar las siguientes comprobaciones:
a) Si el diámetro es superior a 1.4 debe mostrar por consola el mensaje “La rueda es para un vehículo grande”. Si es menor o igual a 1.4 pero mayor que 0.8 debe mostrarse por consola el mensaje “La rueda es para un vehículo mediano”.
